        ...
        <div class="col-lg-12 left-content" style="padding-bottom: 60px;">
            ...
            <div class="col-lg-6 col-lg-offset-3 form auth-form" style="height: 400px; border: 0px solid silver">
                ...
                <form role="form" method="POST" action="{{ url('/login') }}">
                    {{ csrf_field() }}    
                    <h3 class="form-title">Auntenticate</h3>
                    {{--<h3 class="form-title">Auntenticate or <a href="{{ url('register') }}">Sign up</a></h3>--}}
                    {{--<div class="row">--}}
                    ...
                    <div class="row">
                        <div class="col-lg-12">	
                            ...
                            <div class="" style="margin-top: 20px;">
                                <button class="btn btn-primary btn-block" type="submit">Autenticate</button>
                            </div>
                            <div class="row" style="margin-top:8px;">
                                <div class="col-lg-6">
                                    <label>
                                        <input type="checkbox" value="remember-me" class=""> Recordar usuario y contraseña
                                    </label>
                                </div>
                                <div class="col-lg-6">
