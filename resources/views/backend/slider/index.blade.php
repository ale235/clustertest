        ...
        <div class="col-xs-12">
                    ...
                    <table id="sort" class="table table-striped grid">
                        ...
                        @foreach($sliders as $slider)
                            <tr style="
                                ...
                                <td class="index">{{$slider->orden}}</td>
                                <td>
                                    <label class="switch">
                                        <input class="estado" type="checkbox" @if($slider->estado) checked @endif>
            ...
            {!! $sliders->render() !!}
                ...
                <div class="box-footer">
                    <a  href="{{url('/admin/slider/create/')}}"><button type="button" class="btn btn-default pull-left"><i class="fa fa-plus"></i> Agregar Slider</button></a>
                </div>
            </div>
            <!-- /.box -->
        </div>
