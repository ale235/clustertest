...
@section ('content')
    <div class="wizard">
        ...
        <form role="form" enctype="multipart/form-data" method="post" action="{{url('admin/slider/'.$slider->id)}}">
            {{ csrf_field() }}
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="titulo_text" name="titulo_text" maxlength="20" value="{{ old('titulo') ? old('titulo'):@$slider->titulo }}" placeholder="Ingrese el Título: Máx 20">
                            </div>
                            <div class="form-group">
                                <label for="forsubtitulouno">Subtítulo - arriba</label>
                                <input type="text" class="form-control" id="subtitulo_uno" name="subtitulo_uno" maxlength="20" value="{{ old('subtitulo') ? old('subtitulo'):@$slider->subtitulo }}" placeholder="Ingrese el Subtitulo: Máx 20 ">
                            </div>
                            <div class="form-group">
                                <label for="fordescripcion">Descripción</label>
                                <input type="text" class="form-control" id="descripcion" name="descripcion" maxlength="130"  value="{{ old('descripcion') ? old('descripcion'):@$slider->descripcion }}"  placeholder="Ingrese la descripción: Máx 130">
                            </div>
                        </div>
                    </div>
                </div>
